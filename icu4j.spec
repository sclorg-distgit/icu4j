...
%changelog
* Tue Jul 28 2015 Alexander Kurtakov <akurtako@redhat.com> 1:54.1.1-6.3
- Drop Provides/obsoletes outside of DTS namespace.

* Mon Jul 20 2015 Mat Booth <mat.booth@redhat.com> - 1:54.1.1-6.2
- Fix broken sub-package requires

* Wed Jun 24 2015 Mat Booth <mat.booth@redhat.com> - 1:54.1.1-6.1
